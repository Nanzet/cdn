					...
					function b(e) {
						...
						if (n && 'string' == typeof t) {
							...
							if (
								...
								n[i] ||
									((n[i] = T([n[i], n[r.onchange]])), delete n[r.onchange])
							}
						}
					}
					function _(e) {
				...
				function y(e, t, n, r, o) {
					...
					if (0 !== _)
						for (var w = 0; w < _; w++) {
							...
							var N = s.key
							if (null != N)
								h && void 0 !== d[N] && ((c = d[N]), (d[N] = void 0), h--)
							else if (!c && m < y)
								for (i = m; i < y; i++)
					...
					if (!e.__x) {
						...
						if (
							...
							if (_ && O !== _ && a !== w) {
								...
								P &&
									O !== P &&
									(P.replaceChild(O, _), N || ((_._component = null), b(_, !1)))
							}
					...
					return (
						...
						(0, d.default)(t, [
							...
							},
							{
								...
								get: function () {
									return (
										this._accessToke || localStorage.getItem(R.GT_ACCESS_TOKEN)
									)
								},
								set: function (e) {
